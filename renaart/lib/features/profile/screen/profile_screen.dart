      ...
      body: SingleChildScrollView(children: [
        Container(
          ...
          child: Column(children: [
            ...
            Text(user.isGuest ? 'GUEST VISITOR' : '@${user.username}  ·  GALLERY MEMBER',
        ...
        _Card(card, isDark, [
          _ToggleTile(Icons.dark_mode_outlined, 'Dark Mode',
              ...
              isDark ? AppColors.gold : AppColors.ink, isDark, isDark,
...
class _Stat extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(children: [
    Text(count.toString(), style: TextStyle(fontFamily: 'Cormorant', fontSize: 24,
        fontWeight: FontWeight.w700,
        color: isDark ? AppColors.darkText : AppColors.ink)),
    Text(label, style: TextStyle(fontFamily: 'Jost', fontSize: 10,
        letterSpacing: 0.4, color: isDark ? AppColors.darkFaint : AppColors.inkLight)),
  ]);
}
